...
function thinPath(coords, maxPoints = 400) {
...
const SUBTLE_BLUE = [59, 130, 246] // #3b82f6 - single color for subtle animation
...
export function toTripsData(fc, maxPointsPerPath = 400) {
